...
TEST(ProcessInfoProvider, parse_broken) {
  ProcessInfo pinfo;
  ...
  std::string broken3("9631 (vim) S 9593 9631 9593 34825 9631 4194304 1731 0 0 0 18 1 0 0 20 0 1 0");
  ASSERT_FALSE(ProcessInfoProvider::fromString(broken3, "", pinfo));
  ASSERT_TRUE(pinfo.isEmpty());

  std::string good("9631 (vim) S 9593 9631 9593 34825 9631 4194304 1731 0 0 0 18 1 0 0 20 0 1 0 28017391");
...
#ifndef __APPLE__
TEST(ProcessInfoProvider, get_my_process_info) {
  ProcessInfo myself;
