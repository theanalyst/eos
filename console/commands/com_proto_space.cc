...
void com_space_help()
{
  ...
  oss
      ...
      << "space config <space-name> space.groupbalancer.engine.std.threshold=<v>: configure the std engine threshold(%), this is the deviation from avg. groups filled [default=5]\n"
      << "space config <space-name> space.groupbalancer.engine.mm.min_threshold=<v>: configure the min_max engine min threshold(%), groups below this will be picked as targets [default=60]\n"
      << "space config <space-name> space.groupbalancer.engine.mm.max_threshold=<v>: configure the min_max engine max threshold(%), groups above this will be picked as sources [default=95]\n"
