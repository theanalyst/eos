...
void com_space_help()
{
  ...
  oss
      ...
      << "space config <space-name> space." << eos::mgm::tgc::TGC_NAME_FREE_BYTES_QRY_PERIOD_SECS << "=<#>        : delay in seconds between free bytes queries for the tape-aware GC [ default=" << eos::mgm::tgc::TGC_DEFAULT_FREE_BYTES_QRY_PERIOD_SECS << " ]\n"
      << "space config <space-name> space." << eos::mgm::tgc::TGC_NAME_MIN_FREE_BYTES << "=<#>                  : configure the minimum number of free bytes the space should have before the tape-aware GC kicks in [ default=" << eos::mgm::tgc::TGC_DEFAULT_MIN_FREE_BYTES << " ] \n"
      << "space config <space-name> space." << eos::mgm::tgc::TGC_NAME_USED_BYTES_QRY_PERIOD_SECS << "=<#>        : delay in seconds between used bytes queries for the tape-aware GC [ default=" << eos::mgm::tgc::TGC_DEFAULT_USED_BYTES_QRY_PERIOD_SECS << " ]\n"
      << "space config <space-name> space." << eos::mgm::tgc::TGC_NAME_MIN_USED_BYTES << "=<#>                  : configure the minimum number of used bytes the space should have before the tape-aware GC kicks in [ default=" << eos::mgm::tgc::TGC_DEFAULT_MIN_USED_BYTES << " ] \n"
