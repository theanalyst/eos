...
void com_space_help()
{
  ...
  oss
      ...
      << "space config <space-name> space.tgc.freespaceqryperiodsecs=<#>        : delay in seconds between free space queries for the tape-aware GC [ default=" << eos::mgm::tgc::TGC_DEFAULT_FREE_SPACE_QUERY_PERIOD_SECS << " ]\n"
