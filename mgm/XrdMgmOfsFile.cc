...
/*----------------------------------------------------------------------------*/
{
  ...
  std::string creation_path = path;
  {
    ...
    eos_debug("error %d attrmap sys %d user %d attrmapF sys %d user %d",
              error.getErrInfo(), attrmap.count("sys.acl"),
              attrmap.count("user.acl"), attrmapF.count("sys.acl"),
              attrmapF.count("user.acl"));
